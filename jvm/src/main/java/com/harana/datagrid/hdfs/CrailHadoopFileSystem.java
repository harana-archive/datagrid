...
import com.harana.datagrid.CrailDirectory;
import com.harana.datagrid.CrailStore;
import com.harana.datagrid.CrailFile;
import com.harana.datagrid.CrailLocationClass;
import com.harana.datagrid.CrailNode;
...
public class CrailHadoopFileSystem extends FileSystem {
	...
	public CrailHadoopFileSystem() throws IOException {
		logger.info("CrailHadoopFileSystem construction");
		dfs = null;
	}
	...
	public void initialize(URI uri, Configuration conf) throws IOException {
		...
		try {
			...
			logger.info("CrailHadoopFileSystem fs initialization done..");
		} catch(Exception e){
	...
	public void close() throws IOException {
		try {
			logger.info("Closing CrailHadoopFileSystem");
