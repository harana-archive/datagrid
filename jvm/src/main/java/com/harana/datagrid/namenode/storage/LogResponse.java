...
public class LogResponse implements NamenodeState {
	...
	public LogResponse(NamenodeResponse.Void message) {
		this.type = message.getType();
		this.voidRes = message;
	}
	
	public LogResponse(NamenodeResponse.CreateFile message) {
		this.type = message.getType();
		this.createFileRes = message;
	}	
	
	public LogResponse(NamenodeResponse.GetFile message) {
		this.type = message.getType();
		this.getFileRes = message;
	}
	
	public LogResponse(NamenodeResponse.DeleteFile message) {
		this.type = message.getType();
		this.delFileRes = message;
	}	
	
	public LogResponse(NamenodeResponse.RenameFile message) {
		this.type = message.getType();
		this.renameRes = message;
	}
	
	public LogResponse(NamenodeResponse.GetBlock message) {
		this.type = message.getType();
		this.getBlockRes = message;
	}
	
	public LogResponse(NamenodeResponse.GetLocation message) {
		this.type = message.getType();
		this.getLocationRes = message;
	}
	
	public LogResponse(NamenodeResponse.GetDataNode message) {
		this.type = message.getType();
		this.getDataNodeRes = message;
	}	
	
	public LogResponse(NamenodeResponse.PingNameNode message) {
		this.type = message.getType();
